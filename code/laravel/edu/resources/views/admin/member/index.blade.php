...
<body>
  ...
  <div class="page-container">
    ...
    <a href="javascript:;" onclick="member_add('添加用户','/admin/member/add','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a></span> 
      ...
      <table class="table table-border table-bordered table-hover table-bg table-sort">
        ...
        <tbody>
          ...
          <tr class="text-c">
            ...
            <td>{{$i->id}}</td>
            <td>{{$i->username}}</td>
            <td><img src="{{$i->avatar}}" width='50' alt=""></td>
            <td>@if($i->gender=='1')男@elseif($i->gender=='2')女@else 保密 @endif</td>
            <td>{{$i->mobile}}</td>
            <td>{{$i->email}}</td>
            <td>{{$i->created_at}}</td>
            <td class="td-status">
