...
<body>
  ...
  <div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_add('添加专业','admin-add.html','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>
          添加专业</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
    <table class="table table-border table-bordered table-bg">
      ...
      <tbody>
          ...
          <tr class="text-c">
            ...
            <td class="td-manage">
              ...
              <a title="编辑" href="javascript:;"
                onclick="admin_edit('专业编辑','admin-add.html','1','800','500')" class="ml-5"
            ...
            <td class="td-manage">
              <a style="text-decoration:none"
                onClick="admin_start(this,'10001')" href="javascript:;" title="启用"><i
                  ...
                  <a title="编辑" href="javascript:;"
                onclick="admin_edit('专业编辑','admin-add.html','2','800','500')" class="ml-5"
        ...
        <tr class="text-c">
          ...
          <td>{{ $i->id }}</td>
          <td>{{ $i->pro_name }}</td>
          <td>{{ $i->protype->protype_name }}</td>
          <td><img src="{{ $i->cover_img }}" width="100px" alt=""></td>
          <td>{{ $i->view_count }}</td>
          <td>{{ $i->created_at }}</td>
          <td>{{ $i->sort }}</td>
          <td>{{ $i->duration }}</td>
          ...
          <td class="td-manage">
            <a title="编辑" href="javascript:;" onclick="admin_edit('专业编辑','admin-add.html','{{$i->id}}','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
